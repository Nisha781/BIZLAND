    ...
    <div class="row">
        <div class="col-2 bg-dark text-white nav-item p-0">
            ...
            <ul class="list-unstyled mt-4">
                ...
                <li class="nav-link">
                    <a href="{{route('tab.index')}}" class="text-decoration-none text-white"><i class="bi bi-arrows-collapse fs-5 icons"></i>Collapse Setting</a>
                </li>
                <li class="nav-link">
        ...
        <div class="col-10">
            <form action="{{route('website.store')}}" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-3">
                                ...
                                <input type="number" name="icon1" id="icon1" class="form-control input" value="{{$setting->icon1}}">
                            </div>
                            <div class="col-3">
                                <label for="icon2">Projects</label>
                                <input type="number" name="icon2" id="icon2" class="form-control input" value="{{$setting->icon2}}">
                            </div>
                            <div class="col-3">
                                <label for="icon3">Hours Of Support</label>
                                <input type="number" name="icon3" id="icon3" class="form-control input" value="{{$setting->icon3}}">
                            </div>
                            <div class="col-3">
                                <label for="icon4">Hard Workers</label>
                                <input type="number" name="icon4" id="icon4" class="form-control input" value="{{$setting->icon4}}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                    <h1 class="text-center fw-bold mt-2">Brand img</h1>
                        <div class="row mt-3">
                            <div class="col-12">
                                <h3>Brand Image 1</h3>
                                <input type="file" name="image1"  class="form-control" value="{{$setting->image1}}">
                            </div>
                            <div class="col-12">
                                <h3>Brand Image 2</h3>
                                <input type="file" name="image2"  class="form-control" value="{{$setting->image2}}">
                            </div>
                            <div class="col-12">
                                <h3>Brand Image 3</h3>
                                <input type="file" name="image3"  class="form-control" value="{{$setting->image3}}">
                            </div>
                            <div class="col-12">
                                <h3>Brand Image 4</h3>
                                <input type="file" name="image4"  class="form-control" value="{{$setting->image4}}">
                            </div>
                            <div class="col-12">
                                <h3>Brand Image 5</h3>
                                <input type="file" name="image5"  class="form-control" value="{{$setting->image5}}">
                            </div>
                ...
                <div class="card my-4 shadow">
                    <div class="card-body">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <button type="submit" name="btn" id="btn" class="btn btn-dark btn-lg mt-3">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
